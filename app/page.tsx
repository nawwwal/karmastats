  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="relative container mx-auto px-4 py-24 text-center">
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="space-y-4">
              <h1 className="text-6xl font-extrabold tracking-tight lg:text-7xl animate-fadeInDown">
                KARMASTAT
              </h1>
          ...
          <div className="max-w-4xl mx-auto">
              ...
              <Card className="border-2 border-primary/20">
                <CardHeader>
                  <div className="flex items-center space-x-3">
                    ...
                    <CardTitle className="text-2xl">KARMA</CardTitle>
                  </div>
                </CardHeader>
                <CardContent>
            ...
            <Card className="bg-accent/10 border-accent/20">
              <CardContent className="pt-6">
                <blockquote className="text-lg italic text-center text-muted-foreground leading-relaxed">
                ...
                <p className="text-right mt-4 font-medium text-primary">— Alice Walker</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section id="tools" className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-6">Research Tools</h2>
          ...
          {Object.entries(tools).map(([category, calcs]) => (
            <div key={category} className="mb-16">
              <h3 className="text-3xl font-semibold mb-8 capitalize flex items-center">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-6 text-gradient">Environmental Impact</h2>
              <p className="text-xl text-muted-foreground leading-relaxed">
            ...
            <Card className="mb-12 bg-gradient-to-r from-success/10 to-info/10 border-success/20">
              <CardContent className="pt-6">
                ...
                <p className="text-right mt-4 font-medium text-primary">— Adapted from Chinese Proverb</p>
              </CardContent>
            </Card>

            <h3 className="text-3xl font-semibold mb-8 text-center">The Remarkable Impact of Trees</h3>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="text-center">
                <Card className="inline-block p-8 bg-card border-2 border-primary/20">
                  <div className="w-48 h-48 bg-gradient-to-br from-primary to-secondary rounded-lg flex items-center justify-center text-white text-lg font-mono">
                    QR CODE
                    <br />
              ...
              <div className="space-y-6">
                <h3 className="text-2xl font-semibold">Your Support Enables:</h3>
                <div className="space-y-4">
                  {[
        ...
        <div className="container mx-auto px-4">
          <Card className="max-w-3xl mx-auto bg-accent/10 border-accent/20">
            <CardContent className="pt-6">
              ...
              <p className="text-right mt-4 font-medium text-primary">— Nelson Henderson</p>
            </CardContent>
          </Card>
        </div>
      </section>
