...
import { QuickCalcFAB } from "@/components/mobile/bottom-nav"
...
export function LayoutWrapper({ children }: LayoutWrapperProps) {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      <div className="relative z-20" onMouseEnter={handleSidebarMouseEnter} onMouseLeave={handleSidebarMouseLeave}>
        <Sidebar isCollapsed={shouldCollapse} onToggle={toggleSidebar} isHovered={!shouldCollapse} />
      </div>
      <main
        className={cn(
      ...
      >
        <div className="container mx-auto p-6 max-w-none relative">{children}</div>
      </main>
      <BottomNav />
      <QuickCalcFAB />
    </div>
